// Завдання 3. В прикладі до шаблону «Mediator» додати клас
// ConcreteColleague3 та додати повідомлення від нього «Hello!».
using System;
using System.Collections;

//Mediator pattern focuses on providing a mediator between objects for communication.
namespace Mediator.Examples
{
    ...
    // "Mediator" - інтерфейс для взаємодії з Colleague objects 
