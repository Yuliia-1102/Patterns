...
//It is useful when the construction of a complex object requires many different steps or when the order of those steps is important.
namespace Builder
{
    class Program
    {
        ...
        class MargaritaPizzaBuilder : PizzaBuilder
        {
            public override void BuildDough() { pizza.SetDough("pan baked"); }
            public override void BuildSauce() { pizza.SetSauce("mild"); }
            public override void BuildTopping() { pizza.SetTopping("cheese+tomatoes"); }
        }
